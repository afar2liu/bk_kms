...
type CreateBookmarkRequest struct {
	...
	Title         string    `json:"title" binding:"required"`         // 书签标题
	Excerpt       string    `json:"excerpt" binding:"required"`       // 简述
	Tags          []TagItem `json:"tags" binding:"required"`          // 标签列表
	CreateArchive bool      `json:"create_archive" binding:"required"` // 是否创建归档
}
